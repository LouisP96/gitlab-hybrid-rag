...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=20,
        help="Total number of candidates to retrieve before reranking",
    )
    ...
    parser.add_argument(
        "--semantic-only",
        action="store_true",
        help="Use semantic-only retriever (default: hybrid)",
    )
    parser.add_argument(
        "--semantic-weight",
        type=float,
    ...
    parser.add_argument(
        ...
        type=int,
        default=15,
        help="Number of results each system (semantic/BM25) retrieves before fusion",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="Maximum results to return after reranking",
    )
    parser.add_argument(
        "--reranker-batch-size", type=int, default=32, help="Batch size for reranking"
    )
    parser.add_argument(
        "--reranker-model",
        type=str,
