...
for project_index, project in enumerate(all_projects, 1):
    ...
    issues = get_all_pages(
        f"{gitlab_url}/api/v4/projects/{project_id}/issues", params={"state": "all"}
    )
    ...
    milestones = get_all_pages(f"{gitlab_url}/api/v4/projects/{project_id}/milestones")
    ...
    releases = get_all_pages(f"{gitlab_url}/api/v4/projects/{project_id}/releases")
    ...
    pipelines = get_all_pages(f"{gitlab_url}/api/v4/projects/{project_id}/pipelines")
